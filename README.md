...
--2026-03-02 18:00:13--  https://sourceforge.net/projects/boost/files/boost/1.69.0/boost_1_69_0.tar.gz
...
--2026-03-02 18:00:13--  https://sourceforge.net/projects/boost/files/boost/1.69.0/boost_1_69_0.tar.gz/download
Reusing existing connection to sourceforge.net:443.
HTTP request sent, awaiting response... 302 Found
Location: https://downloads.sourceforge.net/project/boost/boost/1.69.0/boost_1_69_0.tar.gz?ts=gAAAAABppaX_bmZxZ7lIr_IfXHYJBrAgxh16hgQl4917Zmak5mgCCk4NG8Ess9rFQOw-pbGLEjBOTjV9ENSDRUfupEi39QUpdw%3D%3D&use_mirror=altushost-swe&r= [following]
--2026-03-02 18:00:14--  https://downloads.sourceforge.net/project/boost/boost/1.69.0/boost_1_69_0.tar.gz?ts=gAAAAABppaX_bmZxZ7lIr_IfXHYJBrAgxh16hgQl4917Zmak5mgCCk4NG8Ess9rFQOw-pbGLEjBOTjV9ENSDRUfupEi39QUpdw%3D%3D&use_mirror=altushost-swe&r=
...
--2026-03-02 18:00:14--  https://altushost-swe.dl.sourceforge.net/project/boost/boost/1.69.0/boost_1_69_0.tar.gz?viasf=1
...
Saving to: ‘boost_1_69_0.tar.gz’
  ...
  109050K .......... .......... .......... .......... .         100%  168M=53s

2026-03-02 18:01:21 (2.00 MB/s) - ‘boost_1_69_0.tar.gz’ saved [111710205/111710205]
```
...
find boost_1_69_0 -name "*.h*" | wc -l

32664

find boost_1_69_0 ! -name "*.h*" ! -name "*.cpp" | wc -l
...
```
grep boost_1_69_0 -rl "boost::asio"
...
'boost_1_69_0/stage/lib/libboost_locale.a' -> 'boost-libs/libboost_locale.a'
'boost_1_69_0/stage/lib/libboost_iostreams.a' -> 'boost-libs/libboost_iostreams.a'
'boost_1_69_0/stage/lib/libboost_system.a' -> 'boost-libs/libboost_system.a'
'boost_1_69_0/stage/lib/libboost_date_time.a' -> 'boost-libs/libboost_date_time.a'
'boost_1_69_0/stage/lib/libboost_random.a' -> 'boost-libs/libboost_random.a'
'boost_1_69_0/stage/lib/libboost_stacktrace_basic.a' -> 'boost-libs/libboost_stacktrace_basic.a'
'boost_1_69_0/stage/lib/libboost_exception.a' -> 'boost-libs/libboost_exception.a'
'boost_1_69_0/stage/lib/libboost_context.a' -> 'boost-libs/libboost_context.a'
'boost_1_69_0/stage/lib/libboost_program_options.a' -> 'boost-libs/libboost_program_options.a'
'boost_1_69_0/stage/lib/libboost_fiber.a' -> 'boost-libs/libboost_fiber.a'
'boost_1_69_0/stage/lib/libboost_graph.a' -> 'boost-libs/libboost_graph.a'
'boost_1_69_0/stage/lib/libboost_atomic.a' -> 'boost-libs/libboost_atomic.a'
'boost_1_69_0/stage/lib/libboost_container.a' -> 'boost-libs/libboost_container.a'
'boost_1_69_0/stage/lib/libboost_stacktrace_noop.a' -> 'boost-libs/libboost_stacktrace_noop.a'
'boost_1_69_0/stage/lib/libboost_wserialization.a' -> 'boost-libs/libboost_wserialization.a'
'boost_1_69_0/stage/lib/libboost_regex.a' -> 'boost-libs/libboost_regex.a'
'boost_1_69_0/stage/lib/libboost_test_exec_monitor.a' -> 'boost-libs/libboost_test_exec_monitor.a'
'boost_1_69_0/stage/lib/libboost_wave.a' -> 'boost-libs/libboost_wave.a'
'boost_1_69_0/stage/lib/libboost_stacktrace_backtrace.a' -> 'boost-libs/libboost_stacktrace_backtrace.a'
'boost_1_69_0/stage/lib/libboost_contract.a' -> 'boost-libs/libboost_contract.a'
'boost_1_69_0/stage/lib/libboost_timer.a' -> 'boost-libs/libboost_timer.a'
'boost_1_69_0/stage/lib/libboost_chrono.a' -> 'boost-libs/libboost_chrono.a'
'boost_1_69_0/stage/lib/libboost_filesystem.a' -> 'boost-libs/libboost_filesystem.a'
'boost_1_69_0/stage/lib/libboost_unit_test_framework.a' -> 'boost-libs/libboost_unit_test_framework.a'
'boost_1_69_0/stage/lib/libboost_stacktrace_addr2line.a' -> 'boost-libs/libboost_stacktrace_addr2line.a'
'boost_1_69_0/stage/lib/libboost_serialization.a' -> 'boost-libs/libboost_serialization.a'
'boost_1_69_0/stage/lib/libboost_prg_exec_monitor.a' -> 'boost-libs/libboost_prg_exec_monitor.a'
'boost_1_69_0/bin.v2/libs/exception/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_exception.a' -> 'boost-libs/libboost_exception.a'
'boost_1_69_0/bin.v2/libs/date_time/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_date_time.a' -> 'boost-libs/libboost_date_time.a'
'boost_1_69_0/bin.v2/libs/serialization/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_wserialization.a' -> 'boost-libs/libboost_wserialization.a'
'boost_1_69_0/bin.v2/libs/serialization/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_serialization.a' -> 'boost-libs/libboost_serialization.a'
'boost_1_69_0/bin.v2/libs/locale/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_locale.a' -> 'boost-libs/libboost_locale.a'
'boost_1_69_0/bin.v2/libs/container/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_container.a' -> 'boost-libs/libboost_container.a'
'boost_1_69_0/bin.v2/libs/stacktrace/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_stacktrace_basic.a' -> 'boost-libs/libboost_stacktrace_basic.a'
'boost_1_69_0/bin.v2/libs/stacktrace/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_stacktrace_noop.a' -> 'boost-libs/libboost_stacktrace_noop.a'
'boost_1_69_0/bin.v2/libs/stacktrace/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_stacktrace_backtrace.a' -> 'boost-libs/libboost_stacktrace_backtrace.a'
'boost_1_69_0/bin.v2/libs/stacktrace/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_stacktrace_addr2line.a' -> 'boost-libs/libboost_stacktrace_addr2line.a'
'boost_1_69_0/bin.v2/libs/chrono/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_chrono.a' -> 'boost-libs/libboost_chrono.a'
'boost_1_69_0/bin.v2/libs/filesystem/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_filesystem.a' -> 'boost-libs/libboost_filesystem.a'
'boost_1_69_0/bin.v2/libs/regex/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_regex.a' -> 'boost-libs/libboost_regex.a'
'boost_1_69_0/bin.v2/libs/atomic/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_atomic.a' -> 'boost-libs/libboost_atomic.a'
'boost_1_69_0/bin.v2/libs/wave/build/gcc-14.2.0/release/link-static/threadapi-pthread/threading-multi/visibility-hidden/libboost_wave.a' -> 'boost-libs/libboost_wave.a'
'boost_1_69_0/bin.v2/libs/random/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_random.a' -> 'boost-libs/libboost_random.a'
'boost_1_69_0/bin.v2/libs/graph/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_graph.a' -> 'boost-libs/libboost_graph.a'
'boost_1_69_0/bin.v2/libs/fiber/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_fiber.a' -> 'boost-libs/libboost_fiber.a'
'boost_1_69_0/bin.v2/libs/program_options/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_program_options.a' -> 'boost-libs/libboost_program_options.a'
'boost_1_69_0/bin.v2/libs/timer/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_timer.a' -> 'boost-libs/libboost_timer.a'
'boost_1_69_0/bin.v2/libs/test/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_test_exec_monitor.a' -> 'boost-libs/libboost_test_exec_monitor.a'
'boost_1_69_0/bin.v2/libs/test/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_unit_test_framework.a' -> 'boost-libs/libboost_unit_test_framework.a'
'boost_1_69_0/bin.v2/libs/test/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_prg_exec_monitor.a' -> 'boost-libs/libboost_prg_exec_monitor.a'
'boost_1_69_0/bin.v2/libs/system/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_system.a' -> 'boost-libs/libboost_system.a'
'boost_1_69_0/bin.v2/libs/context/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_context.a' -> 'boost-libs/libboost_context.a'
'boost_1_69_0/bin.v2/libs/contract/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_contract.a' -> 'boost-libs/libboost_contract.a'
'boost_1_69_0/bin.v2/libs/iostreams/build/gcc-14.2.0/release/link-static/threading-multi/visibility-hidden/libboost_iostreams.a' -> 'boost-libs/libboost_iostreams.a'
```
10. Подсчитайте сколько занимает дискового пространства каждый файл в этой директории.
```
du -ah boost-libs

2.0M	boost-libs/libboost_locale.a
164K	boost-libs/libboost_iostreams.a
4.0K	boost-libs/libboost_system.a
152K	boost-libs/libboost_date_time.a
80K	boost-libs/libboost_random.a
16K	boost-libs/libboost_stacktrace_basic.a
4.0K	boost-libs/libboost_exception.a
20K	boost-libs/libboost_context.a
1.5M	boost-libs/libboost_program_options.a
232K	boost-libs/libboost_fiber.a
824K	boost-libs/libboost_graph.a
4.0K	boost-libs/libboost_atomic.a
152K	boost-libs/libboost_container.a
4.0K	boost-libs/libboost_stacktrace_noop.a
776K	boost-libs/libboost_wserialization.a
2.7M	boost-libs/libboost_regex.a
2.2M	boost-libs/libboost_test_exec_monitor.a
4.5M	boost-libs/libboost_wave.a
20K	boost-libs/libboost_stacktrace_backtrace.a
320K	boost-libs/libboost_contract.a
52K	boost-libs/libboost_timer.a
232K	boost-libs/libboost_chrono.a
400K	boost-libs/libboost_filesystem.a
2.2M	boost-libs/libboost_unit_test_framework.a
36K	boost-libs/libboost_stacktrace_addr2line.a
1.2M	boost-libs/libboost_serialization.a
208K	boost-libs/libboost_prg_exec_monitor.a
20M	boost-libs/
```
11. Найдите *топ10* самых "тяжёлых".
```
du -ah boost-libs | sort -hr
